...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_project'])) {
    if (!csrf_verify($_POST['csrf_token'] ?? '')) {
        $successMsg = "Security check failed.";
    } else {
                ...
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="?delete=<?= $row['id'] ?>&csrf_token=<?= urlencode(csrf_token()) ?>" onclick="return confirm('Are you sure?');" class="btn btn-delete">Delete</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
